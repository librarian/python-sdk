...
@typing.final
class GetSubnetByNameRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___GetSubnetByNameRequest = GetSubnetByNameRequest
...
class ListSubnetsResponse(google.protobuf.message.Message):
    ...
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[nebius.vpc.v1.subnet_pb2.Subnet]: ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[nebius.vpc.v1.subnet_pb2.Subnet] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
