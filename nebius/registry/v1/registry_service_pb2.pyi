...
class ListRegistriesResponse(google.protobuf.message.Message):
    ...
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[nebius.registry.v1.registry_pb2.Registry]: ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[nebius.registry.v1.registry_pb2.Registry] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateRegistryRequest(google.protobuf.message.Message):
    ...
    @property
    def spec(self) -> nebius.registry.v1.registry_pb2.RegistrySpec: ...
    def __init__(
        self,
        *,
        metadata: nebius.common.v1.metadata_pb2.ResourceMetadata | None = ...,
        spec: nebius.registry.v1.registry_pb2.RegistrySpec | None = ...,
    ) -> None: ...
