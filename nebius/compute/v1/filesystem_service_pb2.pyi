...
class CreateFilesystemRequest(google.protobuf.message.Message):
    ...
    @property
    def spec(self) -> nebius.compute.v1.filesystem_pb2.FilesystemSpec: ...
    def __init__(
        self,
        *,
        metadata: nebius.common.v1.metadata_pb2.ResourceMetadata | None = ...,
        spec: nebius.compute.v1.filesystem_pb2.FilesystemSpec | None = ...,
    ) -> None: ...
...
class ListFilesystemsResponse(google.protobuf.message.Message):
    ...
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[nebius.compute.v1.filesystem_pb2.Filesystem]: ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[nebius.compute.v1.filesystem_pb2.Filesystem] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
