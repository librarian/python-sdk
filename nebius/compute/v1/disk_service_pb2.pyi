...
class CreateDiskRequest(google.protobuf.message.Message):
    ...
    @property
    def spec(self) -> nebius.compute.v1.disk_pb2.DiskSpec: ...
    def __init__(
        self,
        *,
        metadata: nebius.common.v1.metadata_pb2.ResourceMetadata | None = ...,
        spec: nebius.compute.v1.disk_pb2.DiskSpec | None = ...,
    ) -> None: ...
...
class ListDisksResponse(google.protobuf.message.Message):
    ...
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[nebius.compute.v1.disk_pb2.Disk]: ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[nebius.compute.v1.disk_pb2.Disk] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
